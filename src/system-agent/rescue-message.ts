...
import { agentTemplateManifestSchema } from "../agents/agent-template-schema.js";
  ...
  switch (operation.kind) {
    ...
    case "create-agent":
      if (
        ...
        !agentTemplateManifestSchema.shape.role.optional().safeParse(operation.role).success ||
        !hasOptionalString(operation, "workspace") ||
        !hasOptionalString(operation, "model")
      ) {
        return null;
